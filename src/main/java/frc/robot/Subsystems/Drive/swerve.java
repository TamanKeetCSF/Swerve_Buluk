...
public class swerve extends SubsystemBase {
    ...
    private static Pigeon2 gyro = new Pigeon2(7);
        ...
        private static SwerveDriveKinematics kinematics = new SwerveDriveKinematics(getModuleTranslations());
                ...
                static ModuleSpark []modules  = new ModuleSpark[4];
                              ...
                              private final static SwerveDrivePoseEstimator m_poseEstimator =
  ...
  else if (useMegaTag2 == true)
  {
    ...
    if(!doRejectUpdate)
    {
      ...
      SmartDashboard.putNumber("PoseD", m_poseEstimator.getEstimatedPosition().getRotation().getDegrees());
    }
}
  }
}
