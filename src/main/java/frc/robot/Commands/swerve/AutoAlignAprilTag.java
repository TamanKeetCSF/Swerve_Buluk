...
public class AutoAlignAprilTag extends Command {
    ...
    // Controladores PID 
    private final PIDController rotationController = new PIDController(0.03, 0.0, 0.0);
    ...
    private static final double LIMELIGHT_HEIGHT = 0.6;   // Camara  altura en metros
    private static final double TARGET_HEIGHT = 1.2;      // AprilTag altura en metros
    ...
    public void execute() {
        ...
        var table = NetworkTableInstance.getDefault().getTable("limelight3");
